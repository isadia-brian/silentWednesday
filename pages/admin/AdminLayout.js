...
const AdminLayout = ({children}) => {
  ...
  return (
    <div className={`flex ${poppins.className}`}>
      <aside className="fixed z-10 py-8 h-screen bg-slate-700 w-[200px] flex flex-col items-center text-center text-white">
        <div className='relative rounded-full h-20 w-20 border border-green-800'>
            <Image src='/images/logo.jpeg' fill alt="logo" className='rounded-full'/>
        </div>
        ...
        <div className='mt-8'>
            <nav>
                ...
                <ul className='cursor-pointer mt-16 flex flex-col space-y-5'>
                <p className='text-sm underline mb-2 shadow-lg'>CHARTS</p>
                {
